    ...
    <section className="py-16 px-4 bg-white dark:bg-gray-900 transition-colors">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          <h2 className="mb-4 text-gray-900 dark:text-white">Наш путь</h2>
        ...
        <div className="relative">
          {/* Линия таймлайна */}
          <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-0.5 bg-slate-200 dark:bg-gray-700" />
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                ...
                <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'md:text-right md:pr-12' : 'md:text-left md:pl-12'}`}>
                  <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-2xl p-6 hover:shadow-lg transition-all duration-300">
                    <div className="inline-block px-3 py-1 bg-slate-900 dark:bg-gray-700 text-white dark:text-gray-100 rounded-lg mb-3">
                      {milestone.year}
                    </div>
                    <h3 className="mb-2 text-gray-900 dark:text-white">{milestone.title}</h3>
                    <p className="text-slate-600 dark:text-gray-300">{milestone.description}</p>
                  </div>
                </div>
                
                {/* Центральная точка */}
                <div className="hidden md:flex absolute left-1/2 transform -translate-x-1/2 items-center justify-center">
                  <div className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-900 dark:bg-gray-700 border-4 border-white dark:border-gray-900 shadow-lg">
