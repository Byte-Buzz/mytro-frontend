...
const benefits = [
  {
    ...
    description:
      "Оптимизированная производительность обеспечивает плавную прокрутку и мгновенную загрузку, даже с тысячами пинов.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Бесшовный опыт на всех ваших устройствах с автоматической облачной синхронизацией.",
  },
  {
    title: "Фокус на приватности",
    description:
      "Ваши данные — только ваши. Контролируйте, что делиться, и держите свои доски приватными, когда хотите.",
  },
  {
